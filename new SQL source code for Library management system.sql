...
CREATE TABLE Rating (
  ...
  PatronID int,
  Rating int,
  primary key(Date_of_rating, EmployeeID, PatronID),
  FOREIGN KEY (PatronID) REFERENCES Patron(PatronID) ON DELETE CASCADE,
...
Insert into Patron (First_name,Last_name,Contact_number,Gender,DOB,NationalID,email,Points) VALUES ('Manu', 'Kele', '+67852627', 'M', '2002-06-12', 'X23P45', 'manukele@gmal.com', 1);
Insert into Patron (First_name,Last_name,Contact_number,Gender,DOB,NationalID,email,Points) VALUES ('Maia', 'Kele', '+67852986', 'F', '1992-09-11', 'D67H89', 'maiakele@gmail.com', 1);
Insert into Patron (First_name,Last_name,Contact_number,Gender,DOB,NationalID,email,Points) VALUES ('Pie', 'Kellerman', '+67838900', 'M', '2011-04-02', 'X09YU8', 'piechart@yahoo.com', 1);
Insert into Patron (First_name,Last_name,Contact_number,Gender,DOB,NationalID,email,Points) VALUES ('Mali', 'Key', '+67834561', 'F', '2010-03-12', 'X93P85', 'malikey@gmail.com', 1);
Insert into Patron (First_name,Last_name,Contact_number,Gender,DOB,NationalID,email,Points) VALUES ('Cairo', 'Jam', '+67862626', 'M', '1960-06-23', 'X27645', 'cairojam@yahoo.com', 1);
Insert into Patron (First_name,Last_name,Contact_number,Gender,DOB,NationalID,email,Points) VALUES ('Eden', 'Frenzy', '+67847013', 'F', '1988-11-19', 'X2330F5', 'edenfrenzy@yahoo.com', 1);
...
Insert into Kids (PatronID, DOB) values (3, '2011-04-02');
Insert into Kids (PatronID, DOB) values (4, '2010-03-12'); 
 
Insert into Elderly (PatronID, DOB) values (5, '1960-06-23');
 
Insert into Adults (PatronID, DOB) values (1, '2002-06-12');
Insert into Adults (PatronID, DOB) values (2, '1992-09-11');
Insert into Adults (PatronID, DOB) values (6, '1988-11-19');
...
Insert into Instance_of_Use (PatronID, AssetID, Time_of_borrow, Time_of_return) values (4, 2, '2022-01-19 11:58:00', '2022-02-01 15:20:00');
...
Insert into Room_Booking(Booking_date, PatronID, RoomID, Start_time, End_time) values ('2022-02-24', 1, 2, '11:00:00', '14:30:00');
...
Insert into Rating (Date_of_rating, EmployeeID, PatronID, Rating) values ('2022-05-24', 2, 2, 5);
Insert into Rating (Date_of_rating, EmployeeID, PatronID, Rating) values ('2022-01-19', 3, 5, 2);
Insert into Rating (Date_of_rating, EmployeeID, PatronID, Rating) values ('2022-02-21', 4, 1, 4);
Insert into Rating (Date_of_rating, EmployeeID, PatronID, Rating) values ('2022-02-24', 1, 2, 5);
Insert into Rating (Date_of_rating, EmployeeID, PatronID, Rating) values ('2022-01-19', 3, 2, 5);
...
#Display the employee's new salary as a view based on ratings greater than 3 stars. The new salary is (the average rating of the employee divided by 100) + (Old salary).

SELECT AVG(Rating.Rating)/10 + Employees.Salary as New_Salary, Employees.Emp_f_name, Employees.Emp_l_name, AVG(Rating.Rating) as Overall_rating, Employees.EmployeeID
From Rating 
Join Employees
ON Employees.EmployeeID = Rating.EmployeeID 
Group by EmployeeID;

#Display the average rating of a book depending on the number of times the book has been borrowed
